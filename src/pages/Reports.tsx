...
import { formatCurrency, mockWeeklySales } from '@/data/mockData';
...
const Reports = () => {
  ...
  const totalTax = currentSales.reduce((sum, s) => sum + s.tax, 0);
  ...
  const stats = [
    ...
    { label: 'Total Tax', value: formatCurrency(totalTax), icon: DollarSign, color: 'text-accent-foreground bg-accent' },
  ];
