        ...
        <DialogContent>
          ...
          <div className="text-center py-8">
            ...
            <p className="text-sm text-muted-foreground mb-2">
              Camera barcode scanning requires Lovable Cloud to be enabled for full functionality.
            </p>
            <p className="text-xs text-muted-foreground">
              For now, use the manual barcode input or tap products directly.
            </p>
          </div>
        </DialogContent>
      </Dialog>
          ...
          {lastSale && (
            <div className="receipt-print">
              <div className="text-center border-b border-dashed border-border pb-4 mb-4">
                <h3 className="font-bold text-foreground">SwiftPOS</h3>
